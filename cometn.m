...
head = line('parent',ax,'color',colors(3,:),'marker','o','linestyle','none', ...
            'xdata',x(1),'ydata',y(1),'Tag','head');

body = matlab.graphics.animation.AnimatedLine('color',colors(1,:),...
    'linestyle',lstyle,...
    'Parent',ax,...
    'MaximumNumPoints',max(1,k),'tag','body');
tail = matlab.graphics.animation.AnimatedLine('color',colors(2,:),...
    'linestyle','-',...
    'Parent',ax,...
